...
def create_dashboard_body(args: list[str]) -> str:
    ...
    Args:
        args: List of [instance_id, volume_id] for metric dimensions
    """
    ...
    return json.dumps(
        {
            "widgets": [
                    ...
                    "properties": {
                        "metrics": [
                            [
                                "AWS/EC2",
                                "StatusCheckFailed",
                                {"Id": "InstanceId", "Value": instance_id},
                                {"stat": "Maximum", "label": "Status Check Failed"},
                            ],
                            [
                                ".",
                                "StatusCheckFailed_Instance",
                                {".": "."},
                                {"stat": "Maximum", "label": "Instance Check Failed"},
                            ],
                            [
                                ".",
                                "StatusCheckFailed_System",
                                {".": "."},
                                {"stat": "Maximum", "label": "System Check Failed"},
                            ],
                        ],
                        "view": "timeSeries",
                        "stacked": False,
                        ...
                        "annotations": {
                            "horizontal": [
                                {"value": 0, "label": "Healthy", "fill": "below"}
                            ]
                        },
                    },
                },
                    ...
                    "properties": {
                        "metrics": [
                            [
                                "OpenClawLab/EC2",
                                "CPU_USER",
                                {"stat": "Average", "label": "CPU User"},
                            ],
                            [
                                ".",
                                "CPU_SYSTEM",
                                {"stat": "Average", "label": "CPU System"},
                            ],
                            [
                                ".",
                                "CPU_IOWAIT",
                                {"stat": "Average", "label": "CPU IOWait"},
                            ],
                        ],
                        "view": "singleValue",
                        "region": aws_region,
                    ...
                    "properties": {
                        "metrics": [
                            ...
                            [
                                ...
                                {"stat": "Average", "label": "Memory Available"},
                            ],
                        ],
                        "view": "singleValue",
                        "region": aws_region,
                ...
                # Row 2: CPU Metrics
                {
                    ...
                    "width": 24,
                    "height": 1,
                    "properties": {"markdown": "## CPU Performance"},
                },
                {
                    "type": "metric",
                    "x": 0,
                ...
                },
                {
                    ...
                    "properties": {
                        ...
                        "annotations": {
                            "horizontal": [
                                {"value": 80, "label": "High CPU", "fill": "above"}
                            ]
                        },
                    },
                },
                # Row 3: Memory Metrics
                {
                    ...
                    "width": 24,
                    "height": 1,
                    "properties": {"markdown": "## Memory Performance"},
                },
                {
                    "type": "metric",
                    "x": 0,
                    ...
                    "properties": {
                        "metrics": [
                            [
                                "OpenClawLab/EC2",
                                "MEM_USED_BYTES",
                                {"stat": "Average", "label": "Used"},
                            ],
                            [
                                ".",
                                "MEM_AVAILABLE_BYTES",
                                {"stat": "Average", "label": "Available"},
                            ],
                        ],
                        "view": "timeSeries",
                        "stacked": False,
                ...
                # Row 4: Disk Usage
                {
                    ...
                    "width": 24,
                    "height": 1,
                    "properties": {"markdown": "## Disk Usage & Performance"},
                },
                {
                    "type": "metric",
                    "x": 0,
                    ...
                    "properties": {
                        "metrics": [
                            [
                                "OpenClawLab/EC2",
                                "INODE_USED",
                                {"stat": "Average", "label": "Inodes Used"},
                            ],
                            [
                                ".",
                                "INODE_FREE",
                                {"stat": "Average", "label": "Inodes Free"},
                            ],
                        ],
                        "view": "timeSeries",
                        "stacked": False,
                    ...
                    "properties": {
                        "metrics": [
                            [
                                ...
                                "VolumeReadBytes",
                                {"VolumeId": volume_id},
                                {"stat": "Sum", "label": "Read Bytes"},
                            ],
                            [
                                ".",
                                "VolumeWriteBytes",
                                {".": "."},
                                {"stat": "Sum", "label": "Write Bytes"},
                            ],
                        ],
                        "view": "timeSeries",
                        "stacked": False,
                    ...
                    "properties": {
                        "metrics": [
                            [
                                "OpenClawLab/EC2",
                                "DISK_READ_OPS",
                                {"stat": "Sum", "label": "Read Ops"},
                            ],
                            [
                                ".",
                                "DISK_WRITE_OPS",
                                {"stat": "Sum", "label": "Write Ops"},
                            ],
                        ],
                        "view": "timeSeries",
                        "stacked": False,
                ...
                # Row 6: Network Performance
                {
                    ...
                    "width": 24,
                    "height": 1,
                    "properties": {"markdown": "## Network Performance"},
                },
                {
                    "type": "metric",
                    "x": 0,
                    ...
                    "properties": {
                        "metrics": [
                            [
                                "OpenClawLab/EC2",
                                "NET_BYTES_SENT",
                                {"stat": "Sum", "label": "Bytes Sent"},
                            ],
                            [
                                ".",
                                "NET_BYTES_RECV",
                                {"stat": "Sum", "label": "Bytes Received"},
                            ],
                        ],
                        "view": "timeSeries",
                        "stacked": False,
                    ...
                    "properties": {
                        "metrics": [
                            [
                                "OpenClawLab/EC2",
                                "NET_PACKETS_SENT",
                                {"stat": "Sum", "label": "Packets Sent"},
                            ],
                            [
                                ".",
                                "NET_PACKETS_RECV",
                                {"stat": "Sum", "label": "Packets Received"},
                            ],
                        ],
                        "view": "timeSeries",
                        "stacked": False,
                    ...
                    "properties": {
                        "metrics": [
                            [
                                "OpenClawLab/EC2",
                                "TCP_ESTABLISHED",
                                {"stat": "Average", "label": "Established"},
                            ],
                            [
                                ".",
                                "TCP_TIME_WAIT",
                                {"stat": "Average", "label": "Time Wait"},
                            ],
                        ],
                        "view": "timeSeries",
                        "stacked": False,
                ...
                # Row 7: SSM & Systems Manager
                {
                    ...
                    "width": 24,
                    "height": 1,
                    "properties": {"markdown": "## Systems Manager & Connectivity"},
                },
                {
                    "type": "metric",
                    "x": 0,
                    ...
                    "properties": {
                        "metrics": [
                            [
                                "AWS/SSM",
                                "CommandsSucceeded",
                                {"stat": "Sum", "label": "Commands Succeeded"},
                            ],
                            [
                                ".",
                                "CommandsFailed",
                                {"stat": "Sum", "label": "Commands Failed"},
                            ],
                            [
                                ".",
                                "CommandsTimedOut",
                                {"stat": "Sum", "label": "Commands Timed Out"},
                            ],
                        ],
                        "view": "timeSeries",
                        "stacked": False,
                    ...
                    "properties": {
                        "metrics": [
                            [
                                ...
                                "VolumeQueueLength",
                                {"VolumeId": volume_id},
                                {"stat": "Average", "label": "Queue Length"},
                            ],
                            [
                                ".",
                            ...
                            [
                                ...
                                {".": "."},
                                {"stat": "Average", "label": "Consumed IOPS"},
                            ],
                        ],
                        "view": "timeSeries",
                        "stacked": False,
...
# Combine instance_id and volume_id outputs for dashboard dimensions
